...
// Test class for verifying Lite package price in Kuwait for both English and Arabic
public class LitePackagesPriceKW {
    ...
    // Test to verify Lite package price in English for Kuwait
    @Test
    public void testLitePackagesPriceEN() {
        test = extent.createTest("Verify Lite Package price in English for Kuwait");
    ...
    // Test to verify Lite package price in Arabic for Kuwait
    @Test
    public void testLitePackagesPriceAR() {
        test = extent.createTest("Verify Lite Package price in Arabic for Kuwait");
        // Navigate to the base URL
        driver.get(Constants.BASE_URL);
