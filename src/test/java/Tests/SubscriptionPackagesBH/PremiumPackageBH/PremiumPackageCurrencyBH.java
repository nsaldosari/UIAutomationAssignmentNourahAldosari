...
public class PremiumPackageCurrencyBH {
    ...
    public void setUp() {
        ...
        actualPremiumPackageCurrencyEN = Constants.SubscribePageFields.Currency.ACTUAL_CURRENCY_BH_EN;
        actualPremiumPackageCurrencyAR = Constants.SubscribePageFields.Currency.ACTUAL_CURRENCY_BH_AR;
    ...
    public void testPremiumPackagesCurrencyEN() {
        test = extent.createTest("Verify Premium Package currency in English for Bahrain");
