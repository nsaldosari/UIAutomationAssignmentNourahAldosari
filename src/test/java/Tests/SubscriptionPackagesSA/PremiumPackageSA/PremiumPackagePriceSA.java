...
// Test class for verifying Premium package price in KSA for both English and Arabic
public class PremiumPackagePriceSA {
    ...
    public void setUp() {
        ...
        actualPremiumPackagePrice = Constants.SubscribePageFields.PackagesPrice.PREMIUM_PACKAGE_ACTUAL_PRICE_SA;
        // Initialize ExtentReports with HTML output configuration
        ExtentSparkReporter spark = new ExtentSparkReporter("target/Spark.html");
        extent.attachReporter(spark);
    }

    // Test to verify Premium package price in English for KSA
    @Test
    public void testPremiumPackagesPriceEN() {
        test = extent.createTest("Verify Premium Package price in English for KSA");
        // Navigate to the URL
