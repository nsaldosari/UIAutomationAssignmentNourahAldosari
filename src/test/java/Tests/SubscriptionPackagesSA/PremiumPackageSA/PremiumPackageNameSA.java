...
// Test class for verifying Premium package name in KSA for both English and Arabic
public class PremiumPackageNameSA {
    ...
    // Test to verify Premium package name in English for KSA
    @Test
    public void testPremiumPackagesNameEN() {
        test = extent.createTest("Verify Premium Package name in English for KSA");
        // Navigate to the URL
